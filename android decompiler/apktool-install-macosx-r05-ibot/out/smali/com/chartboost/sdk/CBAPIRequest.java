package com.chartboost.sdk; class CBAPIRequest {/*
...
.method public appendDeviceInfoParams()V
    ...
    :cond_1
    #v2=(Conflicted);v3=(Integer);v6=(Conflicted);v7=(Conflicted);
    const-string v7, "w"
    ...
    :goto_3
    #v1=(Conflicted);v5=(Conflicted);v9=(Integer);
    return-void
    ...
    :cond_2
    #v0=(Uninit);v1=(Uninit);v2=(Uninit);v3=(Uninit);v4=(Uninit);v5=(Uninit);v6=(Uninit);v7=(Boolean);v9=(Uninit);
    const-string v7, "model"
    ...
    :cond_3
    :try_start_2
    #v0=(Reference);v2=(Conflicted);v3=(Integer);v4=(Reference);v6=(Conflicted);v9=(Integer);
    invoke-virtual {v4}, Landroid/telephony/TelephonyManager;->getDeviceId()Ljava/lang/String;
    :try_end_2
...
.method public sign(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    #v1=(Integer);v2=(Conflicted);v7=(Conflicted);v12=(Conflicted);
    ...
    .local v5, i:I
    :goto_1
    #v5=(Integer);v13=(Conflicted);v14=(Conflicted);
    array-length v10, v4
    ...
    :cond_3
    #v0=(Uninit);v1=(Integer);v3=(Uninit);v4=(Uninit);v5=(Uninit);v6=(Uninit);v9=(Uninit);v11=(Boolean);v13=(Uninit);v14=(Uninit);
    ...
    :cond_4
    #v0=(Reference);v1=(Conflicted);v2=(Conflicted);v3=(Reference);v4=(Reference);v5=(Integer);v6=(Reference);v7=(Conflicted);v9=(Reference);v10=(Integer);v12=(Conflicted);v13=(Conflicted);v14=(Conflicted);
    new-instance v10, Ljava/lang/StringBuilder;
