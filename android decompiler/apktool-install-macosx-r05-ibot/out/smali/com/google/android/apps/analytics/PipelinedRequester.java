package com.google.android.apps.analytics; class PipelinedRequester {/*
...
.method public sendRequests()V
    ...
    :cond_3
    #v0=(Conflicted);v5=(Conflicted);v7=(Conflicted);
    invoke-interface {v3}, Lorg/apache/http/HttpResponse;->getStatusLine()Lorg/apache/http/StatusLine;
    ...
    :cond_5
    #v0=(Integer);v1=(Null);v3=(Reference);v4=(PosShort);
    iget-object v0, p0, Lcom/google/android/apps/analytics/PipelinedRequester;->connection:Lorg/apache/http/impl/DefaultHttpClientConnection;
