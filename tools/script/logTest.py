...
for i in range(loops):
    ...
    if j==0:
        if i%3==0:
            s='cid=1637&type=1&quant=1&items=0&tid=1323&naid=24024744&gcuid=&gcunick=&mobileid=Ppp1&platformid=201&become_user_id=&become_password=&debug=1&gver=16.0.15&gameSlot=103&theme=1'
        else:
            s='cid=1637&state=0&naid=24024744&gcuid=&gcunick=&mobileid=Ppp1&platformid=201&become_user_id=&become_password=&debug=1&gver=16.0.15&gameSlot=93&theme=1'        
    ...
    if j==0:
        headers['Host']='www1.cmdev7.kabam.asia'
        conn=httplib.HTTPConnection('www1.cmdev7.kabam.asia')
    else:
        headers['Host']=host
